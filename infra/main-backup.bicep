...
metadata name = 'News Streaming Demo'
metadata description = 'Creates Event Hubs triggered Azure Functions for news streaming with Flex Consumption plan'
